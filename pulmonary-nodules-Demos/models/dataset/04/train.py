...
class PretrainedAlexNet(object):
    def __init__(self, images, _keep_prob, _is_test=False):
        ...
        self.fc7 = None
        self.fc8 = None
        self.pre_trained_model = np.load(open(os.getcwd() + "/dataset/bvlc_alexnet.npy", "rb"),
...
def train():
    with tf.Session() as sess:
        ...
        train_step = tf.train.MomentumOptimizer(lr, WEIGHT_DECAY_FACTOR).minimize(cross_entropy,
